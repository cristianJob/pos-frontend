...
import DeletePoductForm from "./DeletePoductForm";
              ...
              <tbody className="divide-y divide-gray-200">
                {products.map(product => (
                    <tr key={product.id}>
                      ...
                      <Image src={getImagePath(product.image)} alt={"productos"} width={120} height={120} priority/>
                      </td>
                      ...
                      <td className="relative py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0 ">
                        ...
                        <DeletePoductForm productId={product.id}/>
                        </div>
                      </td>
                    </tr>
                ))}
